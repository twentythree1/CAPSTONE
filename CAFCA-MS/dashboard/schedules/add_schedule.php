...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
        ...
        // Calculate date span from schedule_date to end_date
        $date_span = (strtotime($end_date) - strtotime($schedule_date)) / (60 * 60 * 24);
        ...
        if ($date_span < 0) {
            ...
            if ($conflictResult->num_rows > 0) {
                ...
                $sql = "INSERT INTO schedules (farmer_id, machine_id, schedule_date, date_span, start_time, end_time, status) 
                        VALUES ('$farmer_id', '$machine_id', '$schedule_date', '$date_span', '$start_time', '$end_time', 'Pending')";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="schedule.php?status=Pending" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
